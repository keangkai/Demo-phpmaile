...
$mail->Username = 'Sheree@hotmail.co.za';      		  // SMTP username
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_name'] != '' AND $_POST['form_option'] != '' AND $_POST['form_option2'] != '' AND $_POST['form_option3'] != '' AND $_POST['form_name2'] != '' AND $_POST['form_option4'] != '' AND $_POST['form_message'] != '') {
        ...
        $toemail = 'Sheree@hotmail.co.za';                // Your Email Address
        ...
        if( $botcheck == '' ) {
            ...
            $body = $name.' '.$option.' '.$option2.' '.$option3.' '.$name2.' '.$option4.' '.$message.' '.$referrer;
